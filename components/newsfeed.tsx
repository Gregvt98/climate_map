...
export default function NewsFeed() {
  ...
  //console.log(NEWS[0]);
  return (
    <div className="absolute bottom-10 right-12 w-[320px] max-w-[320px] max-h-[495px] bg-white shadow-md p-4 mt-2 text-sm text-gray-600 outline-none overflow-auto">
